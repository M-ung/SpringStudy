package stdy.springstudy.core.advice;
...
public class MyLogAdvice {
    ...
    @Pointcut("@annotation(stdy.springstudy.core.annotation.MyLog)")
    public void myLog(){}

    @Pointcut("@annotation(stdy.springstudy.core.annotation.MyErrorLog)")
